       ...
       <HeroContainer>
           ...
           <HeroContent>
               <HeroItems>
                   ...
                   <HeroP>NCA&T Computer Science Graduate & Digital Solutionist. </HeroP>
...
:before {
    ...
    left: 0;
    z-index: 2;
    background: linear-gradient(  /* linear gradient for background */
        180deg, 
        rgba(0,0,0,0) 0%,
        rgba(0,0,0,0.6) 100%
        ),
...
font-sized: clamp(1.5rem, 6vw, 4rem);
